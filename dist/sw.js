...
const ASSETS = ['./','./index.html','./app.js?v=13','./style.css?v=13','./cloud.js','./pwa-register.js','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png'].map(path=>new URL(path,BASE).href);
